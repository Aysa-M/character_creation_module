...
def attack(char_name: str, char_class: str) -> str:
    """Defining quantity of damage from a player."""
...
def defence(char_name: str, char_class: str) -> str:
    """Defining quantity of blocked damage from an enemy."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Defining a player skills during a game session: title and quantity.
    """
    if char_class == 'warrior':
